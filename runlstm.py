...
def calgraR(param, yq, yd, lasts, data, tt):
    ...
    grwr3_last_q = copy.deepcopy(gracwr3_q[:, 0]) 
    grwr3_last_d = copy.deepcopy(gracwr3_d[:, 0])
    ...
    grw3_last_q = copy.deepcopy(gracw3_q[0])
    grw3_last_d = copy.deepcopy(gracw3_d[0])
    ...
    grwp3_last_q = copy.deepcopy(gracwp3_q[:, 0])
    grwp3_last_d = copy.deepcopy(gracwp3_d[:, 0])
    ...
    grb3_last_q = copy.deepcopy(incrs_scale(gracb3_q))
    grb3_last_d = copy.deepcopy(incrs_scale(gracb3_d))
    ...
    grwr2_last_q = copy.deepcopy(gracwr2_q[:, 0])
    grwr2_last_d = copy.deepcopy(gracwr2_d[:, 0])
    ...
    grw2_last_q = copy.deepcopy(gracw2_q[0])
    grw2_last_d = copy.deepcopy(gracw2_d[0])
    ...
    grwp2_last_q = copy.deepcopy(gracwp2_q[:, 0])
    grwp2_last_d = copy.deepcopy(gracwp2_d[:, 0])
    ...
    grb2_last_q = copy.deepcopy(gracb2_q[0])
    grb2_last_d = copy.deepcopy(gracb2_d[0])
    ...
    grwr4_last_q = copy.deepcopy(gracwr4_q[:, 0])
    grwr4_last_d = copy.deepcopy(gracwr4_d[:, 0])
    ...
    grw4_last_q = copy.deepcopy(gracw4_q[0])
    grw4_last_d = copy.deepcopy(gracw4_d[0])
    gra_w4 = grarall_iwg(gracw4_q, gracw4_d)

    gracb4 = lambda ft, gracb4_last, it, ygt: np.dot(ft, gracb4_last) + bgt(it, ygt) 
    gracb4_q = gracb4(yq[2][tt].T, lasts[21], yq[1], yq[0])
    gracb4_d = gracb4(yd[2][tt].T, lasts[20], yd[1], yd[0])
    grb4_last_q = copy.deepcopy(gracb4_q[0])
    grb4_last_d = copy.deepcopy(gracb4_d[0])
